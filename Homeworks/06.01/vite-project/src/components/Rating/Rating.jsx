...
const Rating = () => {
  ...
  return (
    <div className={styles.container}>
       <h2 style={{ textAlign: 'center', marginTop: '20px' }}>Приложение для рейтинга</h2>
      <h2 className={styles.title}>Выберите рейтинг</h2>
      <img
      ...
      <div className={styles.buttons}>
        <button onClick={() => handleRatingChange(0)} className={styles.button}>
          Плохо
        </button>
        <button onClick={() => handleRatingChange(1)} className={styles.button}>
          Приемлемо
        </button>
        <button onClick={() => handleRatingChange(2)} className={styles.button}>
          Хорошо
        </button>
        <button onClick={() => handleRatingChange(3)} className={styles.button}>
          Отлично
        </button>
      </div>
    </div>
